...
import pl.edu.pja.dziabor.tpo_03spring_data.DisplayModes.IDisplayMode;
...
public class FlashcardsController {
    ...
    public void run() {
        ...
        List<Entry> all = (List<Entry>) flashcardService.getAllEntries();
        if (all.isEmpty()) {
        ...
        switch (answer2) {
            ...
            case 2:
                ...
                if (words.length == 3) {
                    ...
                    System.out.println("Please exactly 3 words");
                    return;
                }
